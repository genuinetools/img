...
- **linux** [amd64](https://github.com/genuinetools/img/releases/download/v0.4.4/img-linux-amd64)

```console
# Install latest img binary
$ sudo curl -L https://github.com/genuinetools/img/releases/download/v0.4.4/img-linux-amd64 -o /usr/local/bin/img
# Verify the sha256sum
$ export SHASUM=$(curl -L https://github.com/genuinetools/img/releases/download/v0.4.4/img-linux-amd64.sha256 | awk '{ print $1 }')
...
$ img prune 
ID                                                                      RECLAIMABLE     SIZE    DESCRIPTION
sha256:74906c0186257f2897c5fba99e1ea87eb8b2ee0bb03b611f5e866232bfbf6739 true            2.238MiBpulled from docker.io/tonistiigi/copy:v0.1.1@sha25...
ukd45o6w5f41ungzznap9wt0e                                               true            4KiB    local source for context
wx12pbkwa1bjx91u21qgkbc9a*                                              true            692.3MiBmount / from exec /bin/sh -c make static && mv img...
ih9oq8nzijl0znwzb0c57erdl                                               true            52.95MiBmount / from exec /bin/sh -c useradd --create-home...
gmxr9z5klrupyw14dl365t1ac                                               true            5.08KiB local source for dockerfile
8e8zmkcv0r626l22cldtqvgw4*                                              true            113.8MiBlocal source for context
bll23p0f1jhq56t6e0y43gt1j*                                              true            572.6MiBmount / from exec /bin/sh -c git clone https://git...
sha256:0b9cfed6a170b357c528cd9dfc104d8b404d08d84152b38e98c60f50d2ae718b true            1.449MiBpulled from docker.io/tonistiigi/copy:v0.1.1@sha25...
3ojqejkn9kmwmahplzyaj1hh6                                               true            646.5MiBmount / from exec /bin/sh -c go get -u github.com/...
vdgcaqjyh0sphr2kcy1ghyl09                                               true            55.39MiBmount /dest from exec copy /src-0/runc usr/bin/run...
icedqbf4m39f3ldajjx8c61tm                                               true            641.2MiBmount /dest from exec copy /src-0 go/src/github.co...
sha256:f64a552a56ce93b6e389328602f2cd830280fd543ade026905e69895b5696b7a true            1.234MiBpulled from docker.io/tonistiigi/copy:v0.1.1@sha25...
