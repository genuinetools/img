...
- **linux** [amd64](https://github.com/genuinetools/img/releases/download/v0.4.6/img-linux-amd64)

```console
# Install latest img binary
$ sudo curl -L https://github.com/genuinetools/img/releases/download/v0.4.6/img-linux-amd64 -o /usr/local/bin/img
